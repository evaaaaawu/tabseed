...
export default function WaitlistPage() {
	...
	return (
		<div className="mx-auto max-w-md p-6">
			...
			<p className="mb-4 text-sm text-muted-foreground">Enter your email and we\'ll notify you when approved.</p>
			<form onSubmit={handleSubmit} className="space-y-3">
				...
				/>
				<Button type="submit" disabled={isLoading || !email.trim()}>Submit</Button>
